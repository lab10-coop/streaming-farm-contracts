...
module.exports = {
    ...
    networks: {
        ...
        // NOTE: networks with provider init not yet changed to the format expected by hdwallet-provider 1.4
        // are commented out.
        /*
        rinkeby: {
            provider: () =>
        ...
        kovan: {
            provider: () => {
                return new HDWalletProvider({
                    ...
                    providerOrUrl: createProviderForOpenEthereum(
        ...
        xdai: {
            provider: () => {
                return new HDWalletProvider({
                    ...
                    privateKeys: [process.env.XDAI_PRIVKEY],
                    providerOrUrl: createProviderForOpenEthereum(
        ...
        matic: {
            provider: () => {
                return new HDWalletProvider({
                    ...
                    privateKeys: [process.env.MATIC_PRIVKEY],
                    providerOrUrl: createProviderForOpenEthereum(
        ...
        mainnet: {
            provider: () => {
                return new HDWalletProvider({
                    ...
                    privateKeys: [process.env.MAINNET_PRIVKEY],
                    providerOrUrl: createProviderForOpenEthereum(
